...
MESSAGE_ALREADY_CONNECTED = (
    ...
    "Сейчас бот продолжает отправлять уведомления об изменениях "
    "товаров. Управление отслеживанием через Telegram будет "
...
MESSAGE_CONNECT_SUCCESS = (
    ...
    "Управление отслеживанием через Telegram будет добавлено "
    "следующим этапом."
)
