...
class TelegramTargetIntervalHandlerTests(SimpleTestCase):
    ...
    def test_sets_supported_interval(
        ...
        self.client.answer_callback_query.assert_any_call(
            callback_query_id="callback-1",
            text="Интервал изменён: 3 часа.",
        )
    ...
    def test_does_not_update_already_selected_interval(
        self,
        update_target: Mock,
        get_target: Mock,
    ) -> None:
    ...
    def test_rejects_interval_below_sixty_minutes(self) -> None:
        ...
        self.client.answer_callback_query.assert_called_once_with(
            ...
            text=(
                ...
                "Откройте список заново командой /products."
            ),
            show_alert=True,
        )
